...
Here we are requsting our struct interact with the json package. Therefore, any names that do not follow the rules of "Exported identifiers", will not be found by the json package.
